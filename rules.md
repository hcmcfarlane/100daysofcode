...
2. ~~If I code at work, that time won't count towards the challenge.~~ Coding with School of Code counts because I am just learning!
3. I will push code to GitHub every day so that anyone can see my progress.
4. I will update the (Log)[log.md] with the day's progress and provide a link so that others can see my progress.
5. I will work on practicing code in all forms in all scenarios, because I am just learning. ~~real projects, facing real challenges. The time spent doing tutorials, online courses and other similar resources will NOT count towards this challenge.~~ (If you've just started learning to code, read [FAQ](FAQ.md))
